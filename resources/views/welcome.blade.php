                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="wheel-header text-center marg-lg-t140 marg-lg-b340 marg-md-t140 marg-md-b140 marg-sm-t70 ">
                            <h5>With us everywhere is interesting </h5>
                            <h3><span>Wheel</span>  Service</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4 padd-r0 padd-md-lr15">
                        <div class="wheel-service-item text-center wheel-bg3">
                            ...
                            <p>We will provide you with reliable and timely delivery to any destination in the Republic of Kazakhstan. We transport cargo from anywhere in the world. Our main destinations are CIS and European countries. We work 24/7. Cargo tracking. </p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="wheel-testimonial text-center">
                        <p>The company Wheel ™ Cargo transportation was founded in February 1995. Our mission is a convenient and high-quality information service in the field of road cargo transportation. The main priority in our work is the relevance of information. Thank you for your interest in our service, we are always happy to be useful to You!The service selects the nearest suitable carrier, which allows you to significantly reduce the cost of transportation. Both large and small companies can work in the service. You must submit a request and get feedback. A convenient platform for cooperation and customer search.</p>                      
                    </div>
                </div>
            </div>
